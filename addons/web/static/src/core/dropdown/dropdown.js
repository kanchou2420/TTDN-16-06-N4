...
export class Dropdown extends Component {
    ...
    onDropdownStateChanged(args) {
        // Guard against null elements (can happen during component destruction)
        ...
        if (args.emitter.el.parentElement && this.el.parentElement && args.emitter.el.parentElement === this.el.parentElement) {
